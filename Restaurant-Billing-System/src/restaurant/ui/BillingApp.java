...
import restaurant.ui.orders.FoodMenuDialog;
import restaurant.ui.orders.OrderHistoryDialog;
import restaurant.ui.users.CustomerLoginDialog;
...
public class BillingApp extends JFrame {
	...
	public BillingApp(CustomerLoginDialog customerLoginDialog, OrderDAO orderDAO, FoodDAO foodDAO, Customer customer) {
		...
		JLabel lblWelcomeToCafe = new JLabel("WELCOME TO RESTAURANT BILLING SYSTEM");
		lblWelcomeToCafe.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblWelcomeToCafe.setHorizontalAlignment(SwingConstants.CENTER);
		lblWelcomeToCafe.setBounds(75, 22, 335, 100);
