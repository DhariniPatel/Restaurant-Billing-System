...
import restaurant.ui.BillingApp;
...
public class CustomerLoginDialog extends JDialog {
	...
	public CustomerLoginDialog() {
		...
		setTitle("Reastaurant Billing System - Log In");
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				lblWelcomeToCafeteria = new JLabel("Welcome to  Reastaurant Billing System");
